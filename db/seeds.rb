...
OmicReason.create(id: '1', name: 'ALGÚN PROBLEMA CON EL BIEN ADQUIRIDO', description: 'ALGÚN PROBLEMA CON EL BIEN ADQUIRIDO')
OmicReason.create(id: '2', name: 'PROBLEMAS EN LOS SERVICIOS PRESTADOS', description: 'PROBLEMAS EN LOS SERVICIOS PRESTADOS')
OmicReason.create(id: '3', name: 'PROBLEMAS VARIOS', description: 'PROBLEMAS VARIOS')
OmicReason.create(id: '4', name: 'GARANTIAS', description: 'GARANTIAS')
